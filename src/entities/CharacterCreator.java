...
public class CharacterCreator {
    ...
    public static Enemy personagemBuggy() {
        ...
        return new Enemy("Buggy", 400, 200, 115, 105, 130, 160, new BuggyDodgeAbility(), ataquesBuggy);
    }
    ...
    public static Enemy personagemDonKrieg() {
        ...
        return new Enemy("Don Krieg", 560, 220, 135, 125, 80, 260, new DonKriegGoldArmorAbility(), ataquesDonKrieg);
    }
